...
$dConfig['views']['error'] = array('url' => $dConfig['directories']['views'] . 'view_errors.php');
...
$dConfig['actions']['invalid_suite'] = array('url' => $dConfig['directories']['actions'] . 'action_invalid_suite.php');
